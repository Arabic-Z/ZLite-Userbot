...
@Client.on_message(filters.command(["معلومات الحزمه", "mydetails"], [".", ""]) & filters.me)
...
@Client.on_message(filters.command(["steal", "ملصق"], [".", ""]) & filters.me)
...
add_command_help(
    "الملصقات",
    [
        [".ملصق", "This command helps you to kang Stickers."],
        [".معلومات الحزمه", "Get Sticker Pack details."],
    ],
)
