...
@Client.on_message(filters.command(["جو", "جوجل"], ["."]) & filters.me)  
async def gs(client: Client, message: Message):
    ...
    if " " in msg_txt:
        ...
        await message.reply("**- ادخـل كلمـه مـع الامـر ..للبحـث**")
        return
...
@Client.on_message(filters.me & filters.command(["تحليل"], ["."]))
...
add_command_help(
    ...
    [
        ...
        [
            ".تحليل",
            "- لـ اابحـث عـن مصـادر الصـور علـى جـوجـل ريفـرس",
        ],
    ],
)
