...
@Client.on_message(filters.command('انمي بنت', ["."]) & filters.me)
...
@Client.on_message(filters.command('انمي', ["."]) & filters.me)
...
@Client.on_message(filters.command('بيكا', ["."]) & filters.me)
